	  ...
	  public function expresscheckout($data) {
		 ...
		 // ==================================
			...
			$paymentAmount = $data['amount'];
		     $description = 'Self Match Payment';
		     ...
		     //'------------------------------------
		     $returnURL = SITE_URL."Users/paymentPaypal1/".base64_encode($data['uid']);
...
public function CallShortcutExpressCheckout( $paymentAmount, $currencyCodeType, $paymentType, $returnURL, $cancelURL,$description) 
	...
	*/
	...
	//declaring of global variables
		...
		define("API_UserName","testingbydev-developer_api1.gmail.com");
		define("API_Password","1401176928");
		define("API_Signature","AdVLAZiQe0jRM6jFpMrpsB2oBdMxAUG-WFf4Z5DIX0mwUkZgQ0YA9IjM");
