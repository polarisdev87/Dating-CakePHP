        ...
        <div class="warper">
            ...
            <section class="compatibility_report_content">
                    ...
                    <div class="sender_receiver_box sender_box">
                        <div class="sender_receiver_head">
                            ...
                            if(!empty($sender->profile_photo)){ ?>
                                <a href="javascript:;"> <?php echo $this->Html->image("user_images/".$sender->profile_photo,['height'=>'100%','width'=>'100%']); ?></a>
                            <?php }else{ ?>
                        ...
                        <div class="sender_receiver_head">
                            ...
                            <div class="sender_receiver_user">
                              ...
                              //  pr($inUser);die;
                               ...
                               // }else{
                                    $inReceiver = $this->Global->getReceiverNew($receiver_email,$user_id,$post['survey_id']);
                                    $profile=$inReceiver['profile_photo'];
                               // }
                                    if(!empty($profile))
                                    {
                                ?>
                                        <a href="javascript:;"><?php echo $this->Html->image("user_images/".$profile,['height'=>'100%','width'=>'100%']); ?></a>
                                <?php }
                                else{ ?>
                                    <a href="javascript:;"><?php echo $this->Html->image("user_default.jpeg"); ?></a>
                                <?php } ?>
                ...
                <div class="answer_questions">
                    ...
                    <?php  $membership=$this->Global->getMembership($sender['membership_level']);
                 
                   
                        if(($membership['slug']=='platinum') || ($membership['slug']=='visitor' && $survey_for=='2')){
                         echo $this->Html->Link("TrueMatch Score Calculator",['controller'=>'Pages','action'=>'feedback',base64_encode($receiver_email),base64_encode($user_id),base64_encode($post['survey_id'])]); }
                        else{ ?>
                        <a class="pros">TrueMatch Score Calculator</a>
                        <?php } ?>
                    ...
                    <div class="alert alert-danger error"  style="display: none">
                        ...
                        <strong></strong>&nbsp;&nbsp;Please purchase Advanced Survey or upgrade to Platinum Membership to use this feature.
                    </div>
            </section>
        </div>
