                ...
                <div class="dashboard_form_box">
                    ...
                    <div class="dashboard_form_inner">
                        ...
                        <div class="dashboard_form_inner_sub">
                            ...
                            <div class="form_fild_box">
                                <label>State :</label>
                                <?php echo $this->Form->select('state',$states,['empty'=>'Choose Option','class'=>'stateId','label'=>false]); ?>
                            </div>
                            <div class="form_fild_box">
                                <label>City :</label>
                                <?php echo $this->Form->select('city',$cities,['empty'=>'Choose City','class'=>'cityId','label'=>false]); ?>
                            </div>
