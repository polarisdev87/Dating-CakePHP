                    ...
                    <div class="dashboard_form_inner_sub">
                        ...
                        <div class="simple_advanced_button">
                            <ul>
                                ...
                                <li><a href="<?php echo SITE_URL.'Users/paymentpage/'.base64_encode($price)."/".base64_encode($user_id); ?>" class="newpriceBaseStrip">PAY WITH STRIPE</a>
                                    </li>
                            </ul>
						</div>
 ...
 <script>
   ...
   $('.promocodeApply').click(function(){
	...
	var uid = '<?php echo $user_id; ?>';
	 ...
	 $.ajax({
	    type:'POST',
	    data:{promocode:promocode,mainPrice:mainPrice,uid:uid},
	    url:"<?php echo SITE_URL.'Users/checkPromocode';?>",
