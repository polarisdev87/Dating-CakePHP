                        ...
                        <div class="dashboard_form_inner_sub">
                         <?php
                            ...
                            <div class="form_fild_box">
                                ...
                                <div class="form-new2">
                                    <label>Phone</label>
                                    <?php echo $this->Form->input('phone',['placeholder'=>'Phone','label'=>false,'minlength'=>10,'maxlength'=>12]); ?>
                                </div>
                            </div>
                            ...
                            <div class="form_fild_box">
							 ...
							 <div class="form_fild_box">
                                 <label>City*</label>
                                <?php  // $cities=[];
                                    echo $this->Form->select('city',$cities,['placeholder'=>'City','required'=>'required','label'=>false,'class'=>'cityId' ]); ?>
                            </div>
