                    ...
                    <div class="dashboard_form_inner_sub">
                        ...
                        <div class="simple_advanced_button">
                            <ul>
                                ...
                                <li><a href="<?php echo SITE_URL.'Users/paymentpage/'.base64_encode($price) ?>" class="newpriceBaseStrip">Pay WITH CREDIT CARD</a>
                                    </li>
                            </ul>
						</div>
 ...
 <script>
   ...
   $('.promocodeApply').click(function(){
	...
	var promocode = $('.promocodeValue').val();
	 ...
	 $.ajax({
	    type:'POST',
	    data:{promocode:promocode,mainPrice:mainPrice},
