                    ...
                    <div class="dashboard_form_inner">
                        ...
                        <div class="dashboard_form_inner_sub">
                            ...
                            <div class="cards_accepted_box">
                                ...
                                <div class="cards_accepted_list">
                                    <ul>
                                        <li>
                                            <a href="javascript:;">
                                             <input type="radio" name="card_type" required/>
                                        ...
                                        <li>
                                            <a href="javascript:;">
                                             <input type="radio" name="card_type" checked="checked" required/>
                            ...
                            <div class="form_fild_box">
                                ...
                                echo $this->Form->select('country',$countries,['class'=>'country','label'=>false]);  ?>
                            ...
                            <div class="form_fild_box">
                                <label>City :</label>
                                <?php echo $this->Form->input('city',['class'=>'city','placeholder'=>'City','label'=>false]); ?>

                            </div>
                            
                            <div class="form_fild_box">
                                <label>State :</label>
                                <?php echo $this->Form->input('state',['class'=>'state','placeholder'=>'State','label'=>false]); ?>
