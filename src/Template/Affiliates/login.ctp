            ...
            <div class="dashboard_form_box">
                <div class="dashboard_form_inner">
                    <div class="dashboard_form_inner_sub">
                        ...
                        <?php
                            if( $session->read('blocked')){ ?>
                                <div class="alert alert-danger">
                                    ...
                                    array("controller"=>"Affiliates","action"=>"forgotpassword")
                                    ); ?> your password.
                                </div>
                            <?php } ?>
                        ...
                        <div class="form_foot">
                            <p>Not registered? <?php echo $this->Html->link("Register now as Affiliate!",['controller'=>'Affiliates','action'=>'register']); ?></p>
                        </div>
