    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="javascript:;" title="Sample page 1">Edit Cms Page</a>
                </li>
                <li class="pull-right">
                                    ...
                                    <?php echo $this->Form->create($post,array('class'=>'form-horizontal')); ?>
                                        ...
                                        <fieldset>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <?php echo $this->Form->input('title',['class'=>'form-control','label'=>false,'value'=>$post[0]['title']]); ?>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                     <?php echo $this->Form->input('slug',['class'=>'form-control','label'=>false,'value'=>$post[0]['slug'],'disabled'=>true]); ?>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                     <?php echo $this->Form->input('meta_title',['class'=>'form-control','label'=>false,'value'=>$post[0]['meta_title']]); ?>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                     <?php echo $this->Form->input('meta_keyword',['class'=>'form-control','label'=>false,'value'=>$post[0]['meta_keyword']]); ?>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                     <?php echo $this->Form->input('meta_description',['class'=>'form-control','label'=>false,'type'=>'textarea','value'=>$post[0]['meta_description']]); ?>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <?php
                                                    echo $this->Form->textarea("content", array('id'=>'CmspagesContent','value'=>$post[0]['content'])); 
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    echo $this->Form->select('show_on',$options, ['default'=>unserialize($post[0]['show_on']),'class'=>'form-control','multiple'=>'multiple']);
                                                    ?>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    echo $this->Form->select('template', $options, ['default'=>$post[0]['template'],'class'=>'form-control']);
                                                    ?>
